...
class ContactsModel extends Model
{
    ...
    protected $allowedFields    = ['contact_id', 'contact_name', 'contact_picture', 'contact_document', 'contact_audio', 'contact_video', 'other_document', 'contact_email', 'contact_number', 'contact_address'];
